...
namespace TaskApp.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<TaskAppUser> signInManager, ILogger<LoginModel> logger, UserManager<TaskAppUser> userManager)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (user != null && user.Admin == true) // Kullanıcının yönetici olduğunu kontrol ediyoruz
                    {
